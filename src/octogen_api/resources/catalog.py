...
class CatalogResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> CatalogResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/octogen-api-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> CatalogResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/octogen-api-python#with_streaming_response
        """
